...
export function TripItemActions({
  ...
  setTripToMessage,
  setMessageOpen,
  setTripToAssign: _setTripToAssign,
  setAssignOpen: _setAssignOpen,
  setTripToAssignVehicle: _setTripToAssignVehicle,
  setAssignVehicleOpen: _setAssignVehicleOpen,
  setTripToDelete,
  setDeleteDialogOpen,
  updateTripStatus,
  ...
  return (
    <>
      ...
      {/* Assign Driver / Assign Vehicle removed per request */}
