...
export function FinancialReport({
  ...
  const filteredMaintenance = filterDataByDate(
    maintenanceData,
    timeRange,
    dateRange
  );
  ...
  const filteredSpareparts = Array.isArray(sparePartsData)
    ? sparePartsData.filter((part) => {
        ...
        if (!part.quantity_used || Number(part.quantity_used) <= 0)
          return false;

        // Now apply the date filtering
        return (
          filterDataByDate([{ date: partDate }], timeRange, dateRange).length >
          0
        );
      })
    : [];
  ...
  console.log(
    "Financial Report - Maintenance data before filter:",
    maintenanceData
  );
  console.log(
    "Financial Report - Filtered maintenance data:",
    filteredMaintenance
  );
  console.log(
    "Financial Report - Spareparts data before filter:",
    sparePartsData
  );
  console.log(
    "Financial Report - Filtered spareparts data:",
    filteredSpareparts
  );
  ...
  console.log(
    "Financial Report - Completed maintenance items:",
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        ...
        <div className="flex gap-2">
          <Button variant="outline" size="sm" onClick={exportFinancialPDF}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-xs text-muted-foreground">
                  {(
                    (financialData.expenseBreakdown.maintenance /
            ...
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-xs text-muted-foreground">
                  {(
                    (financialData.expenseBreakdown.fuel /
                      financialData.totalExpenses) *
                    100
                  ).toFixed(1)}
                  % of total expenses
            ...
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-xs text-muted-foreground">
                  {(
                    (financialData.expenseBreakdown.spareParts /
                      financialData.totalExpenses) *
                    100
                  ).toFixed(1)}
                  % of total expenses
