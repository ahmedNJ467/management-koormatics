    ...
    <div className="space-y-4">
      <Tabs defaultValue="all" className="w-full">
        <TabsList className="mb-4 grid grid-cols-4 md:w-auto">
          ...
          <TabsTrigger value="in_stock" className="text-green-600">
            In Stock ({inStockParts.length})
          </TabsTrigger>
          <TabsTrigger value="low_stock" className="text-yellow-600">
            Low Stock ({lowStockParts.length})
          </TabsTrigger>
          <TabsTrigger value="out_of_stock" className="text-red-600">
