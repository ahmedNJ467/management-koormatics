...
>(({ className, ...props }, ref) => (
  <div className="relative w-full overflow-x-auto rounded-lg -mx-2 sm:mx-0">
...
>(({ className, ...props }, ref) => (
  <td
    ref={ref}
    className={cn(
      "p-2 sm:p-4 align-middle text-card-foreground [&:has([role=checkbox])]:pr-0 text-xs sm:text-sm",
      className
    )}
    {...props}
  />
