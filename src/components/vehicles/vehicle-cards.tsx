...
export const VehicleCards = memo(
  ({ vehicles, onVehicleClick }: VehicleCardsProps) => {
    ...
    return (
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 p-3 sm:p-6">
        {vehicles
          .map((vehicle) => {
            ...
            return (
              ...
              >
                ...
                <CardContent className="space-y-3">
                  {/* Vehicle Image */}
                  <div className="relative h-60 w-full bg-background rounded-lg overflow-hidden border flex items-center justify-center">
                    {hasImage ? (
                      <img
                        src={
