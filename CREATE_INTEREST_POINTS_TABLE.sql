...
-- Insert sample interest points for Mogadishu area
...
SELECT 'Interest points table created successfully!' as status;
SELECT COUNT(*) as total_interest_points FROM interest_points;
